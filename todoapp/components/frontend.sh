...
sed -i -e '32 /login s/127.0.0.1/login.DOMAIN/g' /etc/nginx/sites-enabled/todo.conf
sed -i -e '36 /todos s/127.0.0.1/todo.DOMAIN/g' /etc/nginx/sites-enabled/todo.conf
