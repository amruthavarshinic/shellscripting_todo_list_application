...
sed -i -e "32 s/127.0.0.1/${comp}.zsdevops.online/" /etc/nginx/sites-enabled/todo.conf
sed -i -e "36 s/127.0.0.1/${comp}.zsdevops.online/" /etc/nginx/sites-enabled/todo.conf
